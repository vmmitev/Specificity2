...
namespace Test.Specificity.ObjectConstrainsSpec
{
    ...
    public static class When_calling_Should_Not_BeLogicallyEqualTo
    {
        ...
        public class with_objects_that_are_logically_equal : Scenario
        {
            ...
            {
                SpecifyThat(new TestObject("xyzzy")).Should.Not.BeLogicallyEqualTo(new TestObject("xyzzy"));
            }
        ...
        public class with_objects_that_are_not_logically_equal : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(new TestObject("magic")).Should.Not.BeLogicallyEqualTo(new TestObject("xyzzy"));
            }
        ...
        [TestClass]
        public class with_objects_that_are_logically_equal_and_given_message : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(new TestObject("xyzzy")).Should.Not.BeLogicallyEqualTo(new TestObject("xyzzy"), "magic {0}", "xyzzy");
            }
