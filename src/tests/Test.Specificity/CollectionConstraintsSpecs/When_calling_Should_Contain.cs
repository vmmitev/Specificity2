...
namespace Test.Specificity.CollectionConstraintsSpecs
{
    ...
    public static class When_calling_Should_Contain
    {
        ...
        public class with_item_in_collection : Scenario
        {
            ...
            {
                SpecifyThat(Collection).Should.Contain("bar");
            }
        ...
        public class with_item_not_in_collection : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(Collection).Should.Contain("xyzzy");
            }
        ...
        [TestClass]
        public class with_item_not_in_collection_and_given_message : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(Collection).Should.Contain("xyzzy", "magic {0}", "xyzzy");
            }
