...
namespace Test.Specificity.CollectionConstraintsSpecs
{
    ...
    public static class When_calling_Should_HaveUniqueItems
    {
        ...
        public class with_collection_of_unique_items : TestScenario
        {
            ...
            {
                Specify.That(Unique).Should.HaveUniqueItems();
            }
        ...
        public class with_collection_containing_duplicate_items : TestScenario
        {
            public override void Because()
            {
                Specify.That(NonUnique).Should.HaveUniqueItems();
            }
        ...
        [TestClass]
        public class with_collection_containing_duplicate_items_and_given_message : TestScenario
        {
            public override void Because()
            {
                Specify.That(NonUnique).Should.HaveUniqueItems("magic {0}", "xyzzy");
            }
        ...
        public class with_collection_containing_multiple_null_references : TestScenario
        {
            public override void Because()
            {
                Specify.That(MultipleNulls).Should.HaveUniqueItems();
            }
