...
namespace Test.Specificity.NumericConstraintsSpec
{
    ...
    public static class When_calling_Should_BeEqualTo
    {
        ...
        public class with_double_within_postive_delta : Scenario
        {
            ...
            {
                SpecifyThat(10.0d).Should.BeEqualTo(10.2d, 0.5d);
            }
        ...
        public class with_double_within_negative_delta : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(10.0d).Should.BeEqualTo(9.8d, 0.5d);
            }
        ...
        public class with_double_not_within_delta : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(10.0d).Should.BeEqualTo(9.4d, 0.5d);
            }
        ...
        [TestClass]
        public class with_double_not_within_delta_and_given_message : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(10.0d).Should.BeEqualTo(9.4d, 0.5d, "magic {0}", "xyzzy");
            }
        ...
        public class with_float_within_postive_delta : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(10.0f).Should.BeEqualTo(10.2f, 0.5f);
            }
        ...
        public class with_float_within_negative_delta : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(10.0f).Should.BeEqualTo(9.8f, 0.5f);
            }
        ...
        public class with_float_not_within_delta : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(10.0f).Should.BeEqualTo(9.4f, 0.5f);
            }
        ...
        [TestClass]
        public class with_float_not_within_delta_and_given_message : Scenario
        {
            protected override void Because()
            {
                SpecifyThat(10.0f).Should.BeEqualTo(9.4f, 0.5f, "magic {0}", "xyzzy");
            }
