...
namespace Test.Specificity.StringConstraintsSpecs
{
    ...
    public static class When_calling_Should_Not_BeEqualTo
    {
        ...
        public class with_equal_strings_using_Ordinal_comparison : TestScenario
        {
            ...
            {
                Specify.That("xyzzy").Should.Not.BeEqualTo("xyzzy", StringComparison.Ordinal);
            }
        ...
        public class with_string_that_differ_using_Ordinal_comparison : TestScenario
        {
            public override void Because()
            {
                Specify.That("xyzzy").Should.Not.BeEqualTo("magic", StringComparison.Ordinal);
            }
        ...
        public class with_strings_that_differ_using_OrdinalIgnoreCase_comparison : TestScenario
        {
            public override void Because()
            {
                Specify.That("xyzzy").Should.Not.BeEqualTo("magic", StringComparison.OrdinalIgnoreCase);
            }
        ...
        [TestClass]
        public class with_equal_strings_and_given_message : TestScenario
        {
            public override void Because()
            {
                Specify.That("xyzzy").Should.Not.BeEqualTo("xyzzy", StringComparison.Ordinal, "magic {0}", "xyzzy");
            }
