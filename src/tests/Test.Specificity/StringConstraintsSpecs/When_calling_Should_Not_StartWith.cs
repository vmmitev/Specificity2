...
namespace Test.Specificity.StringConstraintsSpecs
{
    ...
    public static class When_calling_Should_Not_StartWith
    {
        ...
        public class with_substring_found_at_start : Scenario
        {
            ...
            {
                SpecifyThat("foo bar").Should.Not.StartWith("foo");
            }
        ...
        public class with_string_not_found_at_start : Scenario
        {
            protected override void Because()
            {
                SpecifyThat("foo bar").Should.Not.StartWith("baz");
            }
        ...
        [TestClass]
        public class with_substring_found_at_start_and_given_message : Scenario
        {
            protected override void Because()
            {
                SpecifyThat("foo bar").Should.Not.StartWith("foo", "magic {0}", "xyzzy");
            }
